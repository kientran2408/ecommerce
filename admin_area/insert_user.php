...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (admin_name,admin_username,admin_pass,admin_contact,admin_image) values ('$user_name','$user_username','$user_pass','$user_contact','$user_image')";
